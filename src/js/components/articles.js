...
export const articles = [
    ...
    {
        type: "web",
        title: "7 nuoren elämä päättyi, kun panssarivaunu upposi järveen – pelastuneiden painajainen on kestänyt 30 vuotta: \"En ole puhunut tästä oikeastaan kenellekään\"",
    ...
    {
        type: "web",
        title: "Kymmenen ihmistä asuu vakituisesti pienellä Aspön saarella keskellä Saaristomerta – Tore Johansson kertoo, millaista on elää karussa kodissa",
