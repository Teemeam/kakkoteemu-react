...
export const articles = [
  ...
  {
    type: 'web',
    title: 'Ratikka imi kylkeensä pienen kaupungin verran ihmisiä – näin rakentaminen on mullistunut Tampereella',
  ...
  {
    type: 'web',
    title: '20-vuotias Aarne Kokko kuoli asepalveluksessa – isä kysyy, miksi Puolustusvoimissa tapahtuu jatkuvasti onnettomuuksia',
  ...
  {
    type: 'web',
    title: 'Suomen hallitus haluaa säästää kolme miljardia euroa ja äkkiä – leikkaa itse ja päätä, kuka kärsii',
  ...
  {
    type: 'web',
    title: 'Tarkistimme faktoja EU:sta vuosien varrelta – kokeile tiedätkö, mikä on totta ja mikä tarua',
